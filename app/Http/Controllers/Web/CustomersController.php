...
class CustomersController extends Controller
{
    ...
    {
        $final_theme = $this->theme->theme();
        $title = array('pageTitle' => "Track Order");
        $result = array();
        $result['commonContent'] = $this->index->commonContent();
        return view("web.track-order", ['title' => $title, 'final_theme' => $final_theme])->with('result', $result);
    }
    ...
    {
        $final_theme = $this->theme->theme();
        $title = array('pageTitle' => "Terms and Conditions");
        $result = array();
        $result['commonContent'] = $this->index->commonContent();
        return view("web.terms-and-conditions", ['title' => $title, 'final_theme' => $final_theme])->with('result', $result);
    }
