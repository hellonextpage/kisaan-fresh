...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
	...
	// route for to show payment form using get method
		...
		Route::get('trackOrderPage', 'CustomersController@trackOrderPage');
		Route::get('termsAndConditionsPage', 'CustomersController@termsAndConditionsPage');
	...
	Route::get('/track-order', 'Web\CustomersController@trackOrderPage');
	Route::get('/terms&conditions', 'Web\CustomersController@termsAndConditionsPage');
