        ...
        <style>
          ...
          .sticky-header .header-sticky-inner .pro-header-right-options li a:hover, .btn-link:hover, 
          ...
          .wishilist_count .total_wishlist {
            background: #10A200 !important;
          }
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-3">
                        <ul class="pro-header-right-options">
                            ...
                            <li>
                              <a href="{{ URL::to('/wishlist')}}" class="btn btn-light wishilist_count" >
